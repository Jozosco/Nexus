# 요약 — 15년 11월_Market Monitor Issue.pdf

- **판독(C-04)**: ✅ 정상 · 페이지 13 · 추출 37,619자
- **신호 태그(P1-05)**: 기상이변, 물류충격, 바이오연료수요, 수입관세, 압착, 재고
- **방향성 힌트(P1-05)**: 중립/혼재 (상방어 44 · 하방어 36)
- **엔티티 후보(P1-06)**: Argentina, Brazil, Indonesia, Malaysia, India, China, EU, Ukraine, Korea, Import Duty, WASDE Surprise, ENSO Phase

## 식용유 관련 발췌 (원문 그대로 — provenance)

Feb
Market Monitor
No.33 – November 2015 www.amis-outlook.org
...
makers.
AMIS No. 33 – November 2015 1
World Supply-Demand Outlook
While international prices of all four AMIS
commodities rose slightly in October, they From previous From previous
f’cast season
remained below the corresponding period last
Wheat
year. Weaker prices reflect large export
Maize
availabilities in 2015/16 in the face of generally
Rice
frail import

---
*자동 생성: scripts/summarize_pdfs.py · 출처 파일: `15년 11월_Market Monitor Issue.pdf` (동일 폴더)*