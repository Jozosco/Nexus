# 비정형 요약 — 15년 7월_Market Monitor Issue.pdf

## 1. 문서 기본정보 (템플릿 §1.1/§1.2 — C-04)
| 항목 | 내용 |
|---|---|
| 파일명 | `15년 7월_Market Monitor Issue.pdf` |
...
| 방향성(SBO 가격 기준) | 중립/혼재 (상방어 34 · 하방어 34) |
| 신뢰도 | 자동(키워드 기반) — LLM 정밀 스코어는 Phase B |

## 3. 관련 국가·엔티티 (템플릿 §3.1 — P1-06)
- 정규 엔티티 후보: Import Volume, Export Volume, Soil Moisture Percentile, Production Volume, Soybean, Crude Palm Oil, Neutral Regime, Hold Recommendation, Effective Date, Source Document
...
Feb
Market Monitor
No.30 – July 2015 www.amis-outlook.org
...
makers.
AMIS No. 30 – July 2015 1
World Supply-Demand Outlook
In spite of unfavourable weather conditions in some
r egions and continuing concerns about El Niño,
From previous From previous
which increased market volatility in June, the
f’cast season
general supply/demand outlook for the four AMIS Wheat
crops remains comfortable. The first 2015/16 Maize
forecast 
