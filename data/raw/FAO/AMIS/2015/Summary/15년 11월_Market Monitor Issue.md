# 비정형 요약 — 15년 11월_Market Monitor Issue.pdf

## 1. 문서 기본정보 (템플릿 §1.1/§1.2 — C-04)
| 항목 | 내용 |
|---|---|
| 파일명 | `15년 11월_Market Monitor Issue.pdf` |
...
- 정규 엔티티 후보: Import Volume, Export Volume, Flood, Soil Moisture Percentile, Stock-to-Use Ratio, Soybean, Neutral Regime, Import Tariff, Source Document
