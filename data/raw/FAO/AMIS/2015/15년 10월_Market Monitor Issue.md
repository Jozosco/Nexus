# 요약 — 15년 10월_Market Monitor Issue.pdf

- **판독(C-04)**: ✅ 정상 · 페이지 13 · 추출 37,136자
- **신호 태그(P1-05)**: 기상이변, 물류충격, 바이오연료수요, 생산변동, 수출규제, 압착, 재고
- **방향성 힌트(P1-05)**: 하방 우세 (상방어 23 · 하방어 36)
- **엔티티 후보(P1-06)**: Argentina, Brazil, Indonesia, India, China, EU, Ukraine, Korea, Export Tax, WASDE Surprise
...
---
*자동 생성: scripts/summarize_pdfs.py · 출처 파일: `15년 10월_Market Monitor Issue.pdf` (동일 폴더)*