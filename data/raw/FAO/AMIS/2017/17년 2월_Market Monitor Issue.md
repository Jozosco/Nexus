# 요약 — 17년 2월_Market Monitor Issue.pdf

- **판독(C-04)**: ✅ 정상 · 페이지 16 · 추출 44,348자
- **신호 태그(P1-05)**: 기상이변, 물류충격, 바이오연료수요, 수입관세, 수출규제, 압착, 재고
- **방향성 힌트(P1-05)**: 중립/혼재 (상방어 40 · 하방어 31)
- **엔티티 후보(P1-06)**: Argentina, Brazil, Indonesia, India, China, Ukraine, Korea, Export Tax, Import Duty
...
---
*자동 생성: scripts/summarize_pdfs.py · 출처 파일: `17년 2월_Market Monitor Issue.pdf` (동일 폴더)*