# 비정형 요약 — 22.12_Japan_Biofuels Annual.pdf

## 1. 문서 기본정보 (템플릿 §1.1/§1.2 — C-04)
| 항목 | 내용 |
|---|---|
| 파일명 | `22.12_Japan_Biofuels Annual.pdf` |
...
- 정규 엔티티 후보: Inflation, Import Volume, Export Volume, Crude Palm Oil, Source Document
