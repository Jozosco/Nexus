# 비정형 요약 — 16.06_Russia_Biofuels Annual.pdf

## 1. 문서 기본정보 (템플릿 §1.1/§1.2 — C-04)
| 항목 | 내용 |
|---|---|
| 파일명 | `16.06_Russia_Biofuels Annual.pdf` |
...
- 정규 엔티티 후보: Import Volume, Export Volume, Canola Oil, Export Tax, Source Document
...
further develop the agricultural sector. The goal is not only to cover the gap of import
