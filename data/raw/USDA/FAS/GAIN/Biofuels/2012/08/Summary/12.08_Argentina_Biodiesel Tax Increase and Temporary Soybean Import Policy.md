# 비정형 요약 — 12.08_Argentina_Biodiesel Tax Increase and Temporary Soybean Import Policy.pdf

## 1. 문서 기본정보 (템플릿 §1.1/§1.2 — C-04)
| 항목 | 내용 |
|---|---|
| 파일명 | `12.08_Argentina_Biodiesel Tax Increase and Temporary Soybean Import Policy.pdf` |
...
| 항목 | 값 |
|---|---|
| aspect 신호 태그 | 기상이변, 바이오연료수요, 수출규제, 압착 |
...
- 감지 신호: 기상이변, 바이오연료수요, 수출규제, 압착 → src/semantic/causal_chains.md 의 해당 체인 참조
