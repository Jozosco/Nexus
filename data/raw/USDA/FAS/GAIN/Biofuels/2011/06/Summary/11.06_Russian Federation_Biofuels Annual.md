# 비정형 요약 — 11.06_Russian Federation_Biofuels Annual.pdf

## 1. 문서 기본정보 (템플릿 §1.1/§1.2 — C-04)
| 항목 | 내용 |
|---|---|
| 파일명 | `11.06_Russian Federation_Biofuels Annual.pdf` |
...
| 항목 | 값 |
|---|---|
| aspect 신호 태그 | 바이오연료수요, 생산변동, 수출규제 |
| 방향성(SBO 가격 기준) | 상방 우세 (상방어 25 · 하방어 9) |
...
- 감지 신호: 바이오연료수요, 생산변동, 수출규제 → src/semantic/causal_chains.md 의 해당 체인 참조
...
biofuels in Europe and Asia. The production of biofuel
