# 비정형 요약 — 16.04_Mexico_Oilseeds and Products Annual.pdf

## 1. 문서 기본정보 (템플릿 §1.1/§1.2 — C-04)
| 항목 | 내용 |
|---|---|
| 파일명 | `16.04_Mexico_Oilseeds and Products Annual.pdf` |
...
| 방향성(SBO 가격 기준) | 중립/혼재 (상방어 95 · 하방어 77) |
| 신뢰도 | 자동(키워드 기반) — LLM 정밀 스코어는 Phase B |

## 3. 관련 국가·엔티티 (템플릿 §3.1 — P1-06)
- 정규 엔티티 후보: Gross Domestic Product, Import Volume, Export Volume, Harvested Area, Soybean, Vegetable Oil, Canola Oil, Bull Regime, Bear Regime, Neutral Regime, Source Document, Confidence Score
...
 Continuation of a project developed by one of the major multinational seed companies who i
