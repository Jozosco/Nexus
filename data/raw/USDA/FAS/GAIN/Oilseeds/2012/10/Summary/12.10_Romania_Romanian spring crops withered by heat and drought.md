# 비정형 요약 — 12.10_Romania_Romanian spring crops withered by heat and drought.pdf

## 1. 문서 기본정보 (템플릿 §1.1/§1.2 — C-04)
| 항목 | 내용 |
|---|---|
| 파일명 | `12.10_Romania_Romanian spring crops withered by heat and drought.pdf` |
...
| 방향성(SBO 가격 기준) | 하방 우세 (상방어 4 · 하방어 21) |
...
conditions spurred variations in yields from area to another, even from one plot to ano
