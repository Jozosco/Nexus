# 비정형 요약 — 12.07_Romania_Corn and Sunflower crops Affected by Persistent Drought.pdf

## 1. 문서 기본정보 (템플릿 §1.1/§1.2 — C-04)
| 항목 | 내용 |
|---|---|
| 파일명 | `12.07_Romania_Corn and Sunflower crops Affected by Persistent Drought.pdf` |
...
- 정규 엔티티 후보: Import Volume, Soil Moisture Percentile, Production Volume, Neutral Regime, Source Document
