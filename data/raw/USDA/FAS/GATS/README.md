...
## 재수출 결측 연도 — C-02 검증 완료 (A-086)
| HTS | 결측 연도 | 판정 | 처리 |
|---|---|---|---|
| 1507.10.0000 | 2010, 2016, 2018 | **무역 부재**(전 국가 0) | 정상 0으로 보존 — 대체 금지(D4) |
| 1507.90.4020 | 2012~2014, 2020~2021 | **미보고**(행 없음) | NaN 유지 — 무보간 |
| 1517.90.4035 | 2010, 2020, 2026 | **미보고**(행 없음) | NaN 유지 — 무보간 |

상세: `reports/market/gats_reexport_gap_verification.md`
