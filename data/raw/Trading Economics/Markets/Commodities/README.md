...
- **BDI 재척도**: 9/13 수동본에서 2024~2026 전 계열이 ×1.6~3.4 배율로 바뀜(621값). 봇의 점프 게이트가 차단했던 API 값과
  정합하므로 구 계열의 단위·집계 오류 교정으로 추정함(INFERENCE — 승인자 확인 요청). 3행(4/3·4/6·5/4) 결측은 별도 보완 대상.
