...
| 파일 | 출처 | 공유일 | 연결 문서 |
|---|---|---|---|
| `farmdoc_2025_soy_palm_price_relationship.pdf` | Wang & Janzen, farmdoc daily (15):237, 2025-12-26 | 2026-08-25 | CE-015·CE-022 evidence · extraction_technology 보고서 |
| `Nature_SciRep_2024_enzymatic_degumming_industrial_600tpd.pdf` | Khamies et al., Scientific Reports 14:4064, 2024 | 2026-08-25 | extraction_technology 부록 #6 (원산지별 정제 손실 = CIF 스펙 요인 정량 근거) |
| `farmdoc_2026_RFS_playbook_final_RVO_BBD_feedstock.pdf` | Hubbs & Irwin, farmdoc daily, 2026-06-24 | 2026-08-25 | **CE-022 evidence** — 최종 RVO(BBD 5.4/5.7십억 gal)의 26/27 원료 사용 정량. 부록 2차 '정책 단계 구분'(제안 vs 최종 확정)의 최종 확정 측 원문 |
| `farmdoc_2024_US_Brazil_China_soybean_triangle_20yr.pdf` | farmdoc daily, 2024-02 | 2026-08-25 | 미·브·중 대두 삼각무역 20년 구조 — 시장구조 브리프(D-047)·Soybean Triangle 보강 |
| `review_ABCD_competitiveness_oilseed_trading.pdf` | 학술 리뷰(ABCD 경쟁구조, 12p) | 2026-08-25 | 시장구조 브리프(D-047)·D-044 ABCD 거래구조 참고문헌 |
| `LCA_2024_soybean_supply_chain_Para_Brazil.pdf` | LCA 사례연구(브라질 파라주 대두 공급망) | 2026-08-25 | EUDR·지속가능성 맥락(P1-04 EUDR 갭 항목 참고자료) — 가격 모델 직접 입력 아님 |
| `ML_2025_WCO_biodiesel_engine_hybrid_XGB_blends.pdf` | Hybrid XGB-RF-MLP+PSO(WCO 바이오디젤 엔진 성능 ML) | 2026-08-25 | ⚠️ **가격 예측 무관**(엔진 성능 예측 ML — M-009 방법론에 인용 금지). UCO 원료 축 기술 참고로만 보관 |
| `farmdoc_2025_RD_boom_P1_longrun_oilseed_crushing.pdf` | Janzen & Wang, farmdoc daily, 2025-08-25 | 2026-08-25 | RD붐 시리즈 P1 — 압착 폐기율 60년 추세(2.7%→1.5%, −44%)·유지 추출률 장기 상승. 부록 4차 |
| `farmdoc_2025_RD_boom_P2_squeezing_more_oil_crush.pdf` | Janzen & Wang, farmdoc daily, 2025-09-10 | 2026-08-25 | ★RD붐 시리즈 P2 — **유지 추출률 ~20%**(보드 크러시 가정 18.3% 상회), 2020/21 이후 구조 전환. 2020 이후 SBO 증산분의 **~40%가 압착 구성 변화** 기여. CE-022 메커니즘 보정 근거 |
...
### 부록 11차 반입분 (2026-08-28 · 조정자 공유 5건 — 해시 중복 0)

| 파일 | 출처 | 연결 |
|---|---|---|
| `KSIA_2025_Korea_international_grain_trade_overview.pdf` | 오상현·허태웅, 韓國際農誌 37(4):349-362, 2025(경상국립대) | ★한국 곡물 조달 구조 종합(부록 11차) — 국내 거래 관행(사우회 공동구매·국제 공개경쟁 입찰·모선 2~3항 분할), 국가곡물조달시스템 실패사(aT-STX EGT 지분 인수 무산·AGC 청산 2013), 해외농업개발 Phase I~III(2018 목표 10% vs 실적 3%·2024 확보 260만t 중 반입 14.5%·수출터미널 1개 기업이 반입 93%), 지역 리스크 표 — **D-047 Korea Domestic 축 정책·관행 배경**(사료곡물 중심이나 조달 구조 동형) |
| `KIIT_2026_multiagent_nickel_procurement_DSS.pdf` | 김선오 외, Journal of KIIT 24(7):287-298, 2026-07 | ★**Nexus 아키텍처의 학술 선례**(부록 11차) — 니켈 조달 멀티 AI 에이전트 DSS: 오케스트레이션+역할 에이전트 7종(계획·구매·통관·물류·품질·재무·재고)+HITL 명시. 채용 가능: SHAP 상위 3변수 기반 뉴스 리랭킹(별점 매핑)·충돌 시 우선순위 규칙(재고 안정성>가격>비용)·시나리오 기반 평가. ⚠️예측층은 Ridge·7일 단일 지평 — **가치는 구조 검증이지 모델 이식이 아님** |
...
| `summaries/Avileis_2026_commodity_volatility_biofuel_era.md` (원문 PDF 미회수 — 열람 차단, 발췌 기반 골격) | Avileis, UC Davis ARE 세미나 워킹페이퍼 2026-01(저자 소속 UNL) · 선행판 NCCC-134 2025 | 2026-09-25 | 배경 — 의무수요가 수요곡선을 가파르게 → 대두유 내재변동성 +19%(저자 추정·판본 의존). **CE-020 evidence · methods.yaml MP-18**. 원문 회수 후 정식 변환·요약 교체(A-281) |
